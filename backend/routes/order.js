...
router.get("/getPreCreatedOrdersGroupedByType",requireAuth, getPreCreatedOrdersGroupedByType)
...
router.post("/EditPreOrderTicket",requireAuth, EditPreOrderTicket)
...
router.post("/EditPreOrderFirstWeight",requireAuth, EditPreOrderFirstWeight)
router.post("/addOrderStatement",requireAuth, addOrderStatement)
router.post("/orderFinishState",requireAuth, OrderFinishState)
router.post("/orderFinishStateNoPrice",requireAuth, OrderFinishStateNoPrice)
router.post("/orderIronPriceUpdate",requireAuth, OrderIronPriceUpdate)
router.post("/orderFinishStateFirstPrice",requireAuth, OrderFinishStateFirstPrice)
...
router.post('/changeDeliveryPrice',changeDeliveryPrice)
router.post('/setIronPrices',setIronPrices)
