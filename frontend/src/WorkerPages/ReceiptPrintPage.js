...
const Receipt = ({ order }) => {
    let arr = [], totalWeight = order.ticket[order.ticket.length-1].weightAfter - order.firstWeight.weight;
...
const ReceiptPrintPage = () =>{
    ...
    return(
        <div style={{
            ...
            <button  onClick={(e)=> handlePrint()} className="iron-btn print-btn"> طباعه {<FontAwesomeIcon  icon={faPrint} bounce />}</button>
